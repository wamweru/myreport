        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <a href="update.php"><button class="btn-block btn-success form-control">Back</button></a>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="scrollable">
                <h2 class="text-success"><i>Form 1</i></h2>
                      <table class="table">
                        <thead>
                          <tr>
                                 ...
                                 ?>
                                            ...
                                            while($row=mysqli_fetch_array($select_query)){  
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php echo"<td> <a href=resultsedit.php?id=".$row['id']." class='btn btn-success'><i class='fa fa-lg fa-edit'></i></a>
                                                        <a href=resultadd.php?id=".$row['id']."class='btn btn-secondary'><i class='fa fa-lg fa-plus-circle'></i></td>" ?>
                                                        </tr>
