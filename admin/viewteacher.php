                      ...
                      <table class="table">
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <?php echo"<td> <a href=teacherchange.php?id=".$row['id']." class='btn btn-success'><i class='fa fa-lg fa-edit'></i></a>
                                <a href=deleteteacher.php?id=".$row['id']." class='btn btn-danger'><i class='fa fa-lg fa-trash'></i></a>
                                  </td>" ?>
                          </tr>
