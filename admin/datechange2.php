...
include('connect.php');
	...
	$id=$_GET['id'];
	$query="SELECT*FROM term3 where id='$id'";
...
<?php
  ...
  if(isset($_POST['update'])){
     ...
     $udate=$_POST['date'];
     $utime=$_POST['time'];
     $queryupdate=mysqli_query($conn,"update term3 set event='$uevent',date='$udate',time='$utime' where id='$id'")or die(mysqli_error($conn));
     if($queryupdate){
